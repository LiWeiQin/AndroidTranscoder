package com.lx.transcoder.jni;

import android.util.Log;

import com.google.gson.Gson;
import com.lx.transcoder.bean.VideoInfo;
...
public class FFmpegCmd {
     ...
     * @param listener
     */
    public static void transcode(String srcPath, String outPath, final int targetFPS, int bitrate, int targetWidth, int targetHeight, final long duration, String presets, VideoInfo info, final ProgressListener listener) {
        new Thread() {
            @Override
            public void run() {
                int frame = -1;
